...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2020 at 09:18 AM
...
CREATE TABLE `staffs` (
  ...
  `name` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `father name` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `staffs` (`id`, `idno`, `name`, `father name`, `salary`, `joindate`, `deparment_id`) VALUES
(1, '123456AB1', 'Ko Ko ', 'U Kyaw', 1000000, '2014-02-20', 1),
(2, '123456AB2', 'Aye Aye', 'U Zaw Than Thin', 200000, '2014-06-11', 6),
(3, '123456AB3', 'Myat Sandar Hlaing', 'U Soe Lin', 300000, '2014-02-20', 3),
(4, '123456AB4', 'Daw Htwe Nyo', 'U Nyut Win', 500000, '2014-02-20', 2),
(5, '123456AB5', 'Kay Thwe', 'U Wanna Htun', 450000, '2014-06-11', 4),
